...
define("APP_ID",         "20170513000047215"); //替换为您的APPID
define("SEC_KEY",        "Q8baL5gNpQrbV0Tyy48E");//替换为您的密钥

class TranslateBaidu extends TranslateInterface
{
    public $langList = [
        'zh-CN' => 'zh',
        'en-US' => 'en',
    ...
    {
        $from = $this->getLangCode($from);
        $to = $this->getLangCode($to);
